...
import { AuthToken, CommonService } from "src/app/shared/services/common.service";
...
export class CommonEffects {
    ...
    fetchToken$ = createEffect(() => {
        return this.actions$.pipe(
            ...
            switchMap(({ payload }) => this.commonService.fetchToken(payload.login, payload.password)),
